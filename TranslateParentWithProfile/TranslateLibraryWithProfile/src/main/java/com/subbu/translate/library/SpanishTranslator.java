...
public class SpanishTranslator implements ITranslator {
	...
	public Result translate(String input) {
		...
		try {
			HttpGet request = new HttpGet("https://translate.yandex.net/api/v1.5/tr.json/translate?key=trnsl.1.1.20161116T183928Z.4a55bfb275da42ee.2acf744993f12aa9b8663c1ceb15475d3ca5ad4f&lang=en-es&text="+input);
